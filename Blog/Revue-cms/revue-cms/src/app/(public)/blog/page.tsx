...
export const metadata = buildMetadata({
  title: 'The Revue Blog',
  description:
    'Field notes for modern creative agencies — operations, client management, design, and the future of agency work.',
  path: '/blog',
});
  ...
  return (
    <div className="bg-paper text-ink">
      ...
      <section className="px-7 pb-9 pt-14 text-center md:pt-[56px]">
        <p className="eyebrow eyebrow-dot">The Revue Journal</p>
        <h1 className="headline-serif mx-auto mt-4 max-w-[720px] text-[clamp(2rem,5vw,3.5rem)] leading-[1.15]">
          Field notes on the craft of running a creative agency.
        </h1>
        <p className="dek-serif mx-auto mt-3.5 max-w-[580px] text-lg">
          Operations, client relationships, and what we&apos;re learning building Revue with studios around the world.
        </p>
        <form className="mx-auto mt-8 flex max-w-md justify-center md:hidden" action="/blog">
      ...
      <div className="flex flex-wrap justify-center gap-2 px-7 pb-9">
        <Link href="/blog" className={`pill ${!sp.category ? 'pill-active' : ''}`}>
          All
        </Link>
      ...
      <div className="revue-divider mx-7" />

      {/* Featured */}
      {featured && page === 1 && !sp.q && (
        <section className="px-7 py-10">
          <Link href={`/blog/${featured.slug}`} className="group grid items-center gap-9 md:grid-cols-[1.1fr_1fr]">
      ...
      {featured && page === 1 && !sp.q && <div className="revue-divider mx-7" />}
